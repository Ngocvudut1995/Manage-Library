 ...
 * @author Vu Dang
 */
public class Chi_tiet_traController implements Initializable {
     public class ct_tra {
        ...
        public ct_tra(Integer stt, String MaMuon, String MaSach, String tensach, String MaDocGia, String tendocgia, String NgayMuon, String Hantra, String ngaytra, String tinhtrang, Date today, Date deal, String tentacgia, String theloai, String ngonngu, Double gia, String NXB, Image hinhanh,Date datetra) {
            this.stt = stt;
            this.MaMuon = MaMuon;
            this.MaSach = MaSach;
            this.tensach = tensach;
     ...
     ObservableList<ct_tra> data = FXCollections.observableArrayList();
    Connection cn = null;
    @FXML
    private TableView<ct_tra> Table_muon;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
         try {
             ...
             String str = "SELECT j.*,h.* FROM (SELECT a.MaSach,a.TieuDe,b.TenTheLoai,c.TenTacGia,d.TenNgonNgu,a.Gia,f.TenNXB,a.Hinhanh \n"
                     ...
                     + "WHERE l.MaDocGia = m.MaDocGia  AND l.NgayTra IS NOT NULL) j WHERE h.MaSach =j.MaSach";
             Statement st = null;
             try {
                 st = cn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
                         ResultSet.CONCUR_UPDATABLE);
             } catch (SQLException ex) {
                 Logger.getLogger(Chi_tiet_traController.class.getName()).log(Level.SEVERE, null, ex);
             }
             ...
             while (rs.next()) {
                 ...
                 data.add(new ct_tra(data.size() + 1, rs.getString("MaMuon"), rs.getString("MaSach"),
    ...
    @FXML
    private void focus_row(MouseEvent event) {
         int i = Table_muon.getFocusModel().getFocusedIndex();
         //   System.out.println(i);
         ct_tra pm = data.get(i);
